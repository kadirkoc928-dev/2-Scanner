...
def get_all_tickers():
    ...
    # RUSSELL 2000 - ERWEITERT (1975 Ticker)
    RUSSELL = [
    ...
    # STOXX EUROPE 600 - ERWEITERT (600)
    STOXX = [
        ...
        "INVE-B.ST","INW.MI","IPN.PA","IPN.PA","IPS.MC","IRES.IR","ISP.MI","ITRK.L","ITV.L","ITX.MC","JD.L","JDEP.AS","JMAT.L","JMT.PA","JM.T",
        ...
        "RBI.VI","RCF.PA","RCO.PA","RCP.L","RDSA.L","RDSB.L","REC.MC","REL.L","RENE.L","REP.MC","RHM.DE","RI.PA","RNO.PA","ROCK-B.CO","ROG.SW",
        "ROR.L","ROTH.SW","RRS.L","RR.L","RTO.L","RUI.PA","RWE.DE","RYA.L","SAB.MC","SAF.PA","SAGA.L","SALM.OL","SAMPO.HE","SAN.MC","SAND.ST",
        "SAP.DE","SBRY.L","SCA-B.ST","SCHA.OL","SDF.DE","SEB.PA","SECU-B.ST","SESG.PA","SGE.L","SGO.PA","SGRO.L","SHB-A.ST","SHEL.L","SHL.DE",
        "SIE.DE","SIGN.SW","SINCH.ST","SKA-B.ST","SKF-B.ST","SKG.L","SLHN.SW","SMDS.L","SMIN.L","SN.L","SOBI.ST","SOF.BR","SOLB.BR","SON.L",
        "SOON.SW","SPIE.PA","SPM.MI","SPX.L","SQN.SW","SREN.SW","SRG.MI","SRS.MI","SSAB-A.ST","SSE.L","STAN.L","STERV.HE","STM.PA","STLA.PA",
        "STMN.SW","STMP.PA","SU.PA","SWED-A.ST","SWMA.ST","SY1.DE","SYDB.CO","TALK.L","TATE.L","TEF.MC","TEG.DE","TELE2-B.ST","TEL.OL","TEL2-B.ST",
        "TELIA.HE","TEMN.SW","TEN.MI","TEP.PA","TER.PA","TIE1V.HE","TIT.MI","TKAG.DE","TKWY.AS","TLGO.MC","TLX.DE","TNET.BR","TOP.CO","TRN.MI",
        "TRYG.CO","TSCO.L","TTE.PA","TUI1.DE","TWEKA.HE","UBI.PA","UBSG.SW","UCB.BR","UHR.SW","ULE.MC","UMG.AS","UMI.BR","UNA.AS","UNI.MI",
        "UPM.HE","URW.PA","UTDI.DE","VACN.SW","VALMT.HE","VANT.HE","VCT.PA","VIE.PA","VIG.VI","VK.PA","VOD.L","VOE.VI","VOLV-B.ST","VOW3.DE",
        "VPK.AS","VWS.CO","WAC.DE","WCH.DE","WDP.BR","WHA.L","WIE.VI","WKL.AS","WLN.PA","WORL.PA","WRT1V.HE","YAR.OL","YIT.HE","ZAL.DE","ZURN.SW"
    ]
    
    # DEUTSCHE AKTIEN (DAX + MDAX + SDAX + mehr)
    GERMAN = [
        ...
        "AAD.DE","AAG.DE","ABO.DE","ACX.DE","ADJ.DE","ADL.DE","AG1.DE","AHLA.DE","AM3D.DE","ART.DE","ASME.DE","B8F.DE","BBZA.DE","BIO3.DE",
        "BWB.DE","C0M.DE","CAU.DE","CDZ.DE","CHU.DE","CLIQ.DE","COP.DE","CRZK.DE","CTNK.DE","CWC.DE","CY1K.DE","D4N.DE","DBAN.DE","DLX.DE",
        "E4C.DE","ECF.DE","ED4.DE","EHLE.DE","EJQ.DE","ENL.DE","ERMK.DE","ESL.DE","ESS.DE","ETR.DE","EUZ.DE","EXL.DE","F3C.DE","FAM.DE",
        "FIV.DE","FRA.DE","FTK.DE","G6P.DE","GFG.DE","GKS.DE","GSC1.DE","GXI.DE","H2O.DE","HAEK.DE","HBH.DE","HBM.DE","HDD.DE","HEO.DE",
        "HNL.DE","HPHA.DE","HRZ.DE","HXCK.DE","HYQ.DE","I8D.DE","IBU.DE","INO.DE","INP.DE","IS7.DE","IVU.DE","JDC.DE","JST.DE","KAB.DE",
        "KAP.DE","KTR.DE","KU2.DE","L4X.DE","LAP.DE","LS2.DE","LUS.DE","M5Z.DE","MAQ.DE","MED.DE","MTP.DE","MUB.DE","NA9.DE","NCH2.DE",
        "NFN.DE","NGL.DE","NOL.DE","NUVA.DE","NWO.DE","O4B.DE","OBS.DE","OHB.DE","P4Q.DE","PAT.DE","PFE.DE","PNE3.DE","PRG.DE","PSAN.DE",
        "PWO.DE","QBY.DE","R1B.DE","RCMN.DE","RDC.DE","RHK.DE","RKB.DE","RTC.DE","RTK.DE","S4A.DE","S92.DE","SBS.DE","SCY.DE","SDF.DE",
        "SF3.DE","SIE.DE","SJ1.DE","SLT.DE","SM7.DE","SNM.DE","SPH.DE","SSH.DE","ST5.DE","SUR.DE","SUSE.DE","SVX.DE","SYZ.DE","SZ50.DE",
        "T7O.DE","T9Z.DE","TA1.DE","TBX.DE","TDH.DE","TIMA.DE","TPE.DE","TR9.DE","TT8.DE","TUI.DE","TVG.DE","U6Z.DE","UBK.DE","USE.DE",
        "V3S.DE","V6C.DE","VBK.DE","VH2.DE","VIB3.DE","VMED.DE","VOW.DE","VT9.DE","VWA.DE","W8L.DE","WAS.DE","WDI.DE","WDP.DE","WIG1.DE",
        "WUG.DE","WXE.DE","XONA.DE","YOC.DE","ZPF.DE","ZQX.DE","ZVX.DE"
    ]
